...
import com.epay.transaction.repository.DowntimeAPIRepository;
...
public class DowntimeAPIDao {
    ...
    private final DowntimeAPIRepository downtimeAPIRepository;
    ...
    public List<DowntimeAPIDto> getDowntimeAPIs(String status) {
        ...
        if (downtimeAPIs.isEmpty()) {
            ...
            // TODO : Need to remove this call and move this table in Admin and call via APIs
            downtimeAPIs = downtimeAPIRepository.getDowntimeAPIs(status).orElseThrow();
        }
        return downtimeAPIs;
    }
}
