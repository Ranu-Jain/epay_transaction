...
//import com.epay.transaction.dto.TokenAuditDto;
import com.epay.transaction.dto.TokenDto;
...
import com.epay.transaction.repositary.AuditRepository;
...
public class TokenDao {
    ...
    public TokenDto saveToken(TokenDto tokenDto,String Action) {
      ...
      /*  TokenAuditDto tokenAuditDto = TokenAuditDto.builder().tokenId(token.getId()).actionType(Action).build();
        TokenAudit tokenAudit = objectMapper.convertValue(tokenAuditDto, TokenAudit.class);
        log.info(" saving token data in Audit table");
        auditRepository.save(tokenAudit);
